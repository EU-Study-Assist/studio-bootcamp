...
# Introducing <img src = "R-logo.png" width="100px" height="100px"/> {background-color="black"}
...
::: {.column width="50%"}
<img src="file_manager.jpeg" width="500px" height="350px"/>
:::

::: {.column width="50%"}
<img src = "file_sample.png" width="500px" height="350px"/>
:::

::::

# Let's Get our Hands DIrty {background-image="dscience.jpeg" background-size="50%" background-color="black"}
## Outline
- Importing data
